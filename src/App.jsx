    ...
    <div className="site-shell">
      <header className="site-header">
        <a className="brand" href="#top" onClick={() => setMenuOpen(false)} aria-label="KAO Delivery">
          <span className="brand-word">KAO</span>
          <span className="brand-sub">DELIVERY</span>
        </a>
      ...
      <footer className="site-footer">
        <a className="brand brand--footer" href="#top"><span className="brand-word">KAO</span><span className="brand-sub">DELIVERY</span></a>
        <p>{t.footer}</p>
