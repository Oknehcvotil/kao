      ...
      items: [
        {
          ...
          text: 'Організація та координація контейнерних перевезень, робота з портами, лініями, терміналами та агентами.',
        },
        {
          title: 'Митно-брокерські послуги',
          text: 'Підготовка документів, митне оформлення, супровід контролю та комунікація з усіма учасниками процесу.',
        },
        {
          title: 'Доставка морем',
          text: 'Міжнародні FCL та LCL перевезення з підбором маршруту, лінії та транзитного часу.',
        },
        {
          title: 'Доставка авто',
          text: 'Доставка до/з порту власним автопарком із контролем подачі, маршруту та статусу.',
        },
      ],
    },
    advantages: {
      ...
      items: [
        {
          ...
          text: 'Container shipment coordination with ports, shipping lines, terminals and agents.',
        },
        {
        ...
        {
          title: 'Ocean freight',
          text: 'International FCL and LCL shipping with route, carrier and transit-time selection.',
        },
        {
          title: 'Road delivery',
          text: 'Port pickup and inland delivery with our own truck fleet and full status control.',
        },
      ],
    },
    advantages: {
